...
bool DxfIFace::fileImport(const std::string& fileI, dx_data *fData){
...
bool DxfIFace::fileExport(const std::string& file, DRW::Version v, bool binary, dx_data *fData){
    cData = fData;
...
void DxfIFace::writeEntity(DRW_Entity* e){
    switch (e->eType) {
        case DRW::POINT:
